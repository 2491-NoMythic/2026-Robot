...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  public void updateDesiredRobotAngle() {
    ...
    if(desiredRotation != null){
      RobotState.getInstance().aimingPitch = Math.round(Math.toRadians(90) - desiredRotation.get_0()); //subtracting pitch from 90 degrees becuase math believes 90 degrees is straight up, but servo believes 90 degrees is forward
      RobotState.getInstance().aimingYaw = Math.round(0 - Math.toDegrees(desiredRotation.get_1()) + 90);
    } else {
